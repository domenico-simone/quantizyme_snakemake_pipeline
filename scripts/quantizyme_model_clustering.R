...
option_list = list(
    ...
    make_option(c("-e", "--env_cluster_file"), type="character", default="envcluster.RData",
            help="file where the cluster data will be saved [default= %default] (MANDATORY)"),
...
# save cluster to file which will be used by subtreeing
envcluster <- list()
envcluster[["cluster"]] = cluster
save(envcluster, file = envfile)
